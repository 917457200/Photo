...
namespace ImageShear
{
    public partial class Form4 : Form
    {
        ...
        {
            this.label1.Text = this.pictureBox1.Width.ToString();
            this.label2.Text = this.pictureBox1.Height.ToString();
            this.label3.Text = this.pictureBox1.Image.Width.ToString();
            this.label4.Text = this.pictureBox1.Image.Height.ToString();
        }
        #endregion
        #region 缩放、裁剪图像用到的变量
        /// <summary>
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            if (HeadImageBool)
            {
                Pen p = new Pen(Color.White, 1);//画笔
